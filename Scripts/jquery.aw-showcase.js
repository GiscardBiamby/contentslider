...
(function (jQuery) {
    ...
    jQuery.fn.awShowcase = function (options) {
        ...
        var navButtonsHolder = (options.nav_buttons) ? jQuery(options.nav_buttons) : showcase;
        ...
        if (options.buttons && content_count > 1) {
            ...
            while (i < content_count) {
                ...
                // Add numbers or unicode
					...
					.appendTo(jQuery(navButtonsHolder).find('.showcase-button-wrapper'));
                i++;
            }
        }
        ...
        function changeContent(id, direction) {
            ...
            if (current_id !== id && !animating) {
                ...
                if (options.buttons) {
                    i = 0;
                    navButtonsHolder.find('.showcase-button-wrapper span').each(function () {
                        var object = jQuery(this);
                        object.removeClass('active');
                        if (i === current_id) { object.addClass('active'); }
                        i++;
